    ...
    return (
        <>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', marginBottom: '24px' }}>
                ...
                <div className="glass-panel" style={{ display: 'flex', flexDirection: 'column' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', flex: 1 }}>
                        ...
                        {/* AI API Keys */}
                        <div style={{ ...cardStyle, borderColor: 'rgba(140,0,255,0.2)' }}>
                            <div style={{ marginBottom: '10px' }}>
                            ...
                            <input
                                ...
                                type="password"
                                placeholder="gsk_..."
                                value={config.groqToken || ''}
                                onChange={e => update('groqToken', e.target.value)}
                                style={{
                                    width: '100%', padding: '10px 14px',
                                    background: 'rgba(0,0,0,0.5)', border: '1px solid rgba(140,0,255,0.3)',
                                    borderRadius: '8px', color: '#fff', fontFamily: 'var(--font-display)',
                                    fontSize: '13px', outline: 'none', transition: 'border 0.2s', boxSizing: 'border-box'
                                }}
                                onFocus={e => e.target.style.border = '1px solid rgba(140,0,255,0.8)'}
                                onBlur={e => e.target.style.border = '1px solid rgba(140,0,255,0.3)'}
                            />
                        </div>
                        ...
                        <div style={cardStyle}>
                            ...
                            <input
                                ...
                                style={{
                                    width: '100%', padding: '10px 14px',
                                    background: 'rgba(0,0,0,0.5)', border: '1px solid rgba(0,240,255,0.2)',
                                    borderRadius: '8px', color: '#fff', fontFamily: 'var(--font-display)',
                                    fontSize: '13px', outline: 'none', transition: 'border 0.2s', boxSizing: 'border-box'
                                }}
            ...
            <div style={{ display: 'flex', gap: '12px', justifyContent: 'flex-end' }}>
                <button onClick={resetConfig} className="btn-cyber-ghost">
                    Reset to Defaults
                </button>
                <button onClick={saveConfig} className={`btn-cyber ${saved ? 'success' : ''}`}>
